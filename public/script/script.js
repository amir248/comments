...
// const put3='http://localhost:3700/comments/'+`${id}`+'.json/post';
const form=document.createElement('form');
form.setAttribute('action',put3);
...
legend.innerHTML='CommentarySustem Baron Siteverstausen';
...
// const json ='http://localhost:3700/comments/json/'+`${id}`+'.json/allow-cors';
// amir248.github.io/
async function comments(){
  ...
  // body: undefined,
    referrer: "http://localhost/localhost/",
  ...
  if(first.count!==0){
    for(num;num>=first.count;num--){
      ...
      if(first.count<num){
        ...
        her.style.cssText='color:lightgray;background-color:gray;'
